    ...
    public Boolean searchForProduct(String product) throws InterruptedException
     {
        try 
        {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            Thread.sleep(3000);
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[@class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 css-sycj1h']//child::div[1]//child::div[1]//p[1]"), product),
            ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='root']/div/div/child::div[3]/child::div[1]/child::div[2]/child::div[1]/child::h4"))));
            Thread.sleep(3000);
            return true;
        } 
